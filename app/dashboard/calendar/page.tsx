    ...
    .map((tripSheet) => {
      ...
      return {
        ...
        extendedProps: {
          ...
          clientName: tripSheet.guest_name ?? '',
          parentTripStartDate: getTripParent(tripSheet.trip)?.start_date ?? null,
          parentTripEndDate: getTripParent(tripSheet.trip)?.end_date ?? null,
